...
| 申万L1映射服务 | ✅ | capital `8434aff`：官方计入日期生效区间，5216只，窗口内真换组107只(2.05%)，换组前=unknown不猜 |
| 行业两融聚合 | ✅ | capital `cce919d`：交易所明细×申万聚合，rule-derived available_at(T+1 09:15)，回填2025-01起 |
